const reviews = [
  ...
  {
    name: 'Alane Ribeiro',
    image: 'alane-ribeiro.jpg',
    description:
      'Willian é maravilhoso! Didática excelente, interage muito com os alunos. Gosto muito da didática que ele usa e da forma que ele explica. Parabéns, Professor!'
  },
  {
    name: 'Jorge Bierhals Ramos',
    image: 'jorge-ramos.jpg',
    description:
      'Os cursos do professor Willian Justen são excelentes, sua forma de ensinar é incrível. Caso precise de uma ajuda ele está sempre pronto para ajudar, seja aqui pela plataforma da Udemy ou em suas redes sociais. Recomendo à todos!!!'
  },
  {
    name: 'Lianker Lopes',
    image: 'lianker-lopes.jpg',
    description:
      'Willian é um otimo professor e seus cursos são extremamente uteis, pois focam em praticas reais de mercado e ele faz isso sem perder a excelência técnica mantendo o uso de boas praticas de codigo.'
  },
  {
    name: 'Michael Costa',
    image: 'reviewer.jpg',
    description:
      'Curso de altíssima qualidade. O professor Willian Justen tem uma didática muito boa e nos mostrou várias tecnologias além dessas mencionados no nome do curso em um exemplo real do dia a dia. Estou curtindo tanto o curso, que já até comprei outros dois dele: Aprendendo SVG Do Início ao Avançado e Aprenda a criar sites animados com Greensock, agora só falta começar. '
  },
  {
    name: 'Anuar Daher Neto',
    image: 'reviewer.jpg',
    description:
      'Show! Fiquei impressionado com o domínio que o Willian possui sobre os temas abordados, temas parelelos que surgem ao longo do curso e como ele externa esse domínio passando, com facilidade, tudo que precisando pra ter uma ótima experiência e entender o que é necessário.'
  },
  {
